...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        testText.setTextColor(getResources().getColor(R.color.colorRecieveText));
    ...
    private void receive(byte[] data) {
        if(hexEnabled) {
            ...
            receiveText.append(TextUtil.toCaretString(msg+"\n\n", newline.length() != 0));
//                receiveText.append();
//                tmp += 1;
        }
    }
    ...
    private void parameters(byte[] data){
        ...
        if(check != -1){
            ...
            distance = (float)Integer.parseInt(distanceHexData,16);
            ...
            if(a > 32768) { a -= 65535; }
            elevation = (float) (a/Math.pow(2,7));
            ...
            // 表示
            testText.setText("distance: " + distance + "cm, azimuth: " + azimuth + "°, elevation: " + elevation + "°");
